 ...
 */
class InvoicePositionsRepository extends ServiceEntityRepository
{
...
//    /**
//     * @return InvoicePositions[] Returns an array of InvoicePositions objects
//     */
...
//    public function findOneBySomeField($value): ?InvoicePositions
//    {
//        return $this->createQueryBuilder('i')
//            ->andWhere('i.exampleField = :val')
//            ->setParameter('val', $value)
